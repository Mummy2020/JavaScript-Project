...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        //This overwrites Display_Value if the value is 0
...
function Handle_Operator(Next_Operator) {
    ...
    //Checks if an operator already exist and if Wait_SecondOperand is true,
    //then updates the operator an existsa from the function
