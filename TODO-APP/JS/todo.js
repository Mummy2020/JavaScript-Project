/* this function gets task from input*/
function get_todos() {
    /*This creates an array of tasks that are inputed*/
    var todos = new Array;
    /*this pulls the task that was saved in the web browser memory*/
    var todos_str = localStorage.getItem('todo');
    /*If the input is not then JSON.parse will
...
function add() {
    /*This function adds the inputed to the get_todos function array*/
...
function show() {
    ...
    var html = '<ul>';
    /*This displays a task to the list in the order that it is iputed*/
